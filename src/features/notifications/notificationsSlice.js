...
// import { extendedApiSlice } from "../users/usersSlice"
  ...
  endpoints: builder => ({
    getNotifications: builder.query({
      ...
      async onCacheEntyAdded(
        ...
        //perform cleanup steps once the `caqcheentryRemoved` promise resolves
        ws.close()
      }
    })
  })
...
selectEntities: selectMetaEntities} = 
